...
The `2.1.0` report checked into this release records 8 TensorStudio wins and
95 losses versus NumPy-comparable cases. JAX CPU dispatch was available locally;
TensorStudio recorded 39 wins and 59 losses versus JAX dispatch. TensorFlow and
PyTorch were not installed in that benchmark environment.
