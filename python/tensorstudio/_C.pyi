...
class Tensor:
    ...
    def to(self, target: str | Device) -> Tensor: ...
    def to_device(self, device: str | Device) -> Tensor: ...
    def cpu(self) -> Tensor: ...
    def backward(self, gradient: Tensor | None = None, retain_graph: bool = False) -> None: ...
    def zero_grad(self) -> None: ...
    def zero_(self) -> Tensor: ...
    def fill_(self, value: float) -> Tensor: ...
    def add_(self, other: Any, alpha: float = 1.0) -> Tensor: ...
...
def device_count(type: str | Device = "cpu") -> int: ...
